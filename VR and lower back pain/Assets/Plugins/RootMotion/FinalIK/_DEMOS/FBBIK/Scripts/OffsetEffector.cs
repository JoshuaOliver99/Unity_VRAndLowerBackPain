...
namespace RootMotion.Demos {
	...
	public class OffsetEffector : OffsetModifier {
        ...
        [Tooltip("Optional. Assign the bone Transform that is closest to this OffsetEffector to be able to call OffsetEffector.Anchor() in LateUpdate to match it's position and rotation to animation.")]
